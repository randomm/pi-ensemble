...
import {
  ...
  inlineHandoffOpsPrompt,
  inlineLensFixPrompt,
  inlineMergePrompt,
  inlineStepBackPrompt,
} from "./work-driver-prompts-late.ts";
import { SKIP_MARKERS, countSkipMarkersInDiffLine } from "./work-driver-skip-ratchet.ts";
...
function mechanizeOpsEnabled(): boolean {
